...
**Ce qu'il faut chercher à la place :** une brosse en caoutchouc souple (parfois appelée "brosse anti-emmêlement" ou "brosse en silicone"). Ce type de brosse guide les poils vers la turbine sans les enrouler autour de l'axe. Les fabricants la désignent chacun à leur manière : Roborock documente un « double système anti-enchevêtrements » jusque sur son [Q7 L5+](https://www.amazon.fr/dp/B0DWK8GJZX?tag=aspirob0d-21) d'entrée de gamme, iRobot monte deux brosses en caoutchouc sur son [Roomba Max 775 Combo](https://www.amazon.fr/dp/B0GXWTH75T?tag=aspirob0d-21). Le nom commercial change, le principe est le même — et c'est ce principe qu'il faut chercher sur la fiche, pas la marque.
...
<figure class="diagram">
  <img src="/diagrams/placement.svg" alt="Vue de dessus. À gauche, la station est le long d'un mur dégagé et le robot se réamarre du premier coup. À droite, un meuble collé à la station rend l'approche impossible : le robot rate l'amarrage et tombe en panne de batterie." width="820" height="400" loading="lazy" decoding="async" />
  <figcaption>L'erreur la plus fréquente, et la plus simple à corriger : il suffit de déplacer la station.</figcaption>
</figure>
